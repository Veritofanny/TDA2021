        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-">Guardar producto</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
    <p>En esta seccion se encuentra toda la informacion de la ropa</p>
</div>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 col-light" style="margin-left:80px">
    <table id="example" class="table table-light" style="width:100%,">
            ...
            <tr>
                    ...
                    <button type="button" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eraser" viewBox="0 0 16 16">
                    <path d="M8.086 2.207a2 2 0 0 1 2.828 0l3.879 3.879a2 2 0 0 1 0 2.828l-5.5 5.5A2 2 0 0 1 7.879 15H5.12a2 2 0 0 1-1.414-.586l-2.5-2.5a2 2 0 0 1 0-2.828l6.879-6.879zm2.121.707a1 1 0 0 0-1.414 0L4.16 7.547l5.293 5.293 4.633-4.633a1 1 0 0 0 0-1.414l-3.879-3.879zM8.746 13.547 3.453 8.254 1.914 9.793a1 1 0 0 0 0 1.414l2.5 2.5a1 1 0 0 0 .707.293H7.88a1 1 0 0 0 .707-.293l.16-.16z"/>
                    </svg></i></button></td>
                    <td>Abrigos de Lana de Alpaca</td>
                    <td>Perú SAC</td>
                    <td>1000.00</td>
                    <td>10-06-2021</td>
                    <td>400 Unidades</td>
                ...
                <td style="text-align:center"><button type="button" class="btn btn-warning">
                    ...
                    <td>Dunk Low Retro SP 'Kentukcy'</td>
                    <td>Nike</td>
                    <td>250.00</td>
                    <td>20-06-2021</td>
                    <td>010 Unidades</td>
                ...
                <td style="text-align:center"><button type="button" class="btn btn-warning">
                    ...
                    <td>Bolso pequeño de hombro Gucci Horsebit 1955</td>
                    <td>Gucci</td>
                    <td>1660.19</td>
                    <td>20-06-2021</td>
                    <td>003 Unidades</td>
                ...
                <td style="text-align:center"><button type="button" class="btn btn-warning">
                    ...
                    <td>PVFK X NEW ERA TIE DYE TRUCKER HAT</td>
                    <td>Peruvian Flake</td>
                    <td>25.09</td>
                    <td>15-06-2021</td>
                    <td>020 Unidades</td>
                    <td>005 Unidades</td>
                ...
                <td style="text-align:center"><button type="button" class="btn btn-warning">
                    ...
                    <td>Sombrero de Pedro Castillo</td>
                    <td>Cajamarquino SAC</td>
                    <td>20.00</td>
                    <td>20-06-2021</td>
                    <td>999 Unidades</td>
                    <td>001 Unidades</td>
