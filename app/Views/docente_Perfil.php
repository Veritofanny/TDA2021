    ...
    <div class="col-md-4 col-xl-3">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <img src="<?php echo base_url('assets/img/avatars/avatar-4.jpg'); ?>" alt="Christina Mason" class="img-fluid rounded-circle mb-2" width="128" height="128" />
                <h5 class="card-title mb-0">Christina Mason</h5>
                <div class="text-muted mb-2">Docente Principal</div>
            ...
            <hr class="my-0" />
            <div class="card-body">
                <h5 class="h6 card-title">Especialidades</h5>
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="mb-1"><span data-feather="home" class="feather-sm mr-1"></span> Vive en <a href="#">San Francisco, SA</a></li>

                    <li class="mb-1"><span data-feather="briefcase" class="feather-sm mr-1"></span> Trabaja en <a href="#">GitHub</a></li>
                    <li class="mb-1"><span data-feather="map-pin" class="feather-sm mr-1"></span> De <a href="#">Boston</a></li>
                </ul>
            </div>
            <hr class="my-0" />
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body h-100">
                ...
                <div class="d-flex align-items-start">
                    <img src="<?php echo base_url('assets/img/avatars/avatar-5.jpg'); ?>" width="36" height="36" class="rounded-circle mr-2" alt="Vanessa Tucker">
                ...
                <hr />
                <div class="d-flex align-items-start">
                    <img src="<?php echo base_url('assets/img/avatars/avatar.jpg'); ?>" width="36" height="36" class="rounded-circle mr-2" alt="Charles Hall">
                    <div class="flex-grow-1">
                ...
                <hr />
                <div class="d-flex align-items-start">
                    <img src="<?php echo base_url('assets/img/avatars/avatar-4.jpg'); ?>" width="36" height="36" class="rounded-circle mr-2" alt="Christina Mason">
                    <div class="flex-grow-1">
                ...
                <hr />
                <div class="d-flex align-items-start">
                    <img src="<?php echo base_url('assets/img/avatars/avatar-2.jpg'); ?>" width="36" height="36" class="rounded-circle mr-2" alt="William Harris">
                    <div class="flex-grow-1">
                        ...
                        <div class="row g-0 mt-1">
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <img src="<?php echo base_url('assets/img/photos/unsplash-1.jpg'); ?>" class="img-fluid pr-2" alt="Unsplash">
                            </div>
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <img src="<?php echo base_url('assets/img/photos/unsplash-2.jpg'); ?>" class="img-fluid pr-2" alt="Unsplash">
                            </div>
                        </div>
...
<img src="<?php echo base_url('assets/img/avatars/avatar-4.jpg'); ?>" width="36" height="36" class="rounded-circle mr-2" alt="Christina Mason">
                ...
                <hr />
                <a href="#" class="btn btn-primary btn-block">Cargar más</a>
            </div>
        </div>
    </div>
</div>
